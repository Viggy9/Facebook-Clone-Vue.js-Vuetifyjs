<template>
    <v-card rounded outlined>
        <div>
            <v-list-item>
                ...
                <v-list-item-content class="mt-2">
                    <v-list-item-title class="subtitle questrial">Rahul Krishnan</v-list-item-title>
                    <v-list-item-subtitle class="caption blue--text">Friends</v-list-item-subtitle>
                </v-list-item-content>
            </v-list-item>
        </div>
        ...
        <!-- </v-container> -->
        <v-card-text>
            <div class=" body1 mb-4">{{lorem}}</div>
            <v-divider></v-divider>
            <v-layout class="py-4">
         ...
         <v-list-item style="align-items:normal">
            ...
            <div class="px-4">
                <v-text-field class="questrial" height="45px" background-color="grey lighten-3" placeholder="Write a comment..." rounded></v-text-field>
            </div>
    </v-card>
</template>
